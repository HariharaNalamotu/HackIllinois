...
export const nodeDefinitions: NodeDefinition[] = [
  ...
  // ── Chunk variants ────────────────────────────────────────────────────────
  {
    type: 'chunkAuto',
    label: 'Auto Chunk',
    description: 'AI-assisted chunking that picks the best strategy automatically',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  ...
  {
    type: 'chunkSentence',
    label: 'Sentence Chunk',
    description: 'Split text at sentence boundaries using NLP sentence detection',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  ...
  {
    type: 'chunkParagraph',
    label: 'Paragraph Chunk',
    description: 'Split text at paragraph breaks (double newlines)',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  ...
  {
    type: 'chunkSlidingWindow',
    label: 'Sliding Window',
    description: 'Overlapping fixed-size chunks with configurable stride',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  ...
  {
    type: 'chunkFixedSize',
    label: 'Fixed Size Chunk',
    description: 'Split into exactly N tokens/characters per chunk',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  },
  {
    ...
    description: 'Split at Markdown heading boundaries (##, ###, etc.)',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  ...
  {
    type: 'chunkRecursive',
    label: 'Recursive Chunk',
    description: 'Recursively split using a hierarchy of separators',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  },
  {
    type: 'chunkCode',
    label: 'Code Chunk',
    description: 'Split source code at function/class boundaries',
    icon: SplitSquareHorizontal,
    category: 'processing',
    color: '#2dd4bf',
    requiredInput: 'textInput',
  ...
  // ── Embedding variants ────────────────────────────────────────────────────
  {
    type: 'embeddingMiniLM',
    label: 'MiniLM L6 v2',
    description: 'Fast 90 MB sentence-transformer; great for general-purpose RAG',
    icon: Layers,
    category: 'processing',
    color: '#00d4ff',
    requiredInput: 'textInput',
  },
  {
    type: 'embeddingMPNet',
    label: 'MPNet Base v2',
    description: 'High-quality 420 MB embedding model with strong semantic understanding',
    icon: Layers,
    category: 'processing',
    color: '#00d4ff',
    requiredInput: 'textInput',
  ...
  {
    type: 'embeddingBGESmall',
    label: 'BGE Small EN',
    description: 'Compact 130 MB BGE model; fast and accurate for English text',
    icon: Layers,
    category: 'processing',
    color: '#00d4ff',
    requiredInput: 'textInput',
  ...
  {
    type: 'embeddingBGEBase',
    label: 'BGE Base EN',
    description: 'Larger 440 MB BGE model; highest accuracy for English embeddings',
    icon: Layers,
    category: 'processing',
    color: '#00d4ff',
    requiredInput: 'textInput',
  ...
  {
    type: 'embeddingMultilingual',
    label: 'Multilingual MiniLM',
    description: '470 MB multilingual model supporting 50+ languages',
    icon: Layers,
    category: 'processing',
    color: '#00d4ff',
    requiredInput: 'textInput',
  ...
  {
    type: 'classifierResNet50',
    label: 'ResNet-50',
    description: 'Fine-tune ResNet-50 for image classification (ImageFolder format)',
    icon: Eye,
    category: 'processing',
    color: '#a855f7',
    requiredInput: 'imageInput',
  ...
  {
    type: 'classifierConvNeXt',
    label: 'ConvNeXt Tiny',
    description: 'Fine-tune ConvNeXt Tiny – modern CNN with transformer-like performance',
    icon: Eye,
    category: 'processing',
    color: '#a855f7',
    requiredInput: 'imageInput',
  ...
  {
    type: 'classifierResNet18',
    label: 'ResNet-18',
    description: 'Lightweight ResNet-18 for fast training on small datasets',
    icon: Eye,
    category: 'processing',
    color: '#a855f7',
    requiredInput: 'imageInput',
  ...
  // ── Object detector variants ──────────────────────────────────────────────
  {
    type: 'detectorYOLOS',
    label: 'YOLO-S Tiny',
    description: 'Fine-tune YOLO-S Tiny (30 MB) – fastest real-time object detector',
    icon: Scan,
    category: 'processing',
    color: '#f472b6',
    requiredInput: 'imageInput',
  ...
  },
  {
    type: 'detectorRTDETR',
    label: 'RT-DETR R18',
    description: 'Fine-tune RT-DETR R18 (150 MB) – transformer-based real-time detector',
    icon: Scan,
    category: 'processing',
    color: '#f472b6',
    requiredInput: 'imageInput',
  ...
  },
  {
    ...
    description: 'Fine-tune DETR ResNet-50 (160 MB) – end-to-end transformer detector',
    icon: Scan,
    category: 'processing',
    color: '#f472b6',
    requiredInput: 'imageInput',
  ...
  // ── Audio speech variants ─────────────────────────────────────────────────
  {
    type: 'audioWhisper',
    label: 'Whisper Tiny',
    description: 'Fine-tune OpenAI Whisper Tiny for speech-to-text transcription',
    icon: Mic,
    category: 'processing',
    color: '#22c55e',
    requiredInput: 'audioInput',
  },
  {
    type: 'audioWav2Vec2',
    label: 'Wav2Vec2 Base',
    description: 'Fine-tune Wav2Vec2 Base for audio classification tasks',
    icon: Mic,
    category: 'processing',
    color: '#22c55e',
    requiredInput: 'audioInput',
  ...
  {
    type: 'audioWav2Vec2Emotion',
    label: 'Wav2Vec2 Emotion',
    description: 'Fine-tune Wav2Vec2 SUPERB for emotion recognition (7 classes)',
    icon: Mic,
    category: 'processing',
    color: '#22c55e',
    requiredInput: 'audioInput',
  ...
  // ── Tabular model variants ────────────────────────────────────────────────
  {
    type: 'tabularLSTM',
    label: 'LSTM',
    description: 'Long Short-Term Memory network for sequential/time-series tabular data',
    icon: BarChart3,
    category: 'processing',
    color: '#fb923c',
    requiredInput: 'spreadsheetInput',
  },
  {
    type: 'tabularGRU',
    label: 'GRU',
    description: 'Gated Recurrent Unit – lighter alternative to LSTM for sequences',
    icon: BarChart3,
    category: 'processing',
    color: '#fb923c',
    requiredInput: 'spreadsheetInput',
  },
  {
    type: 'tabularRNN',
    label: 'Vanilla RNN',
    description: 'Simple Recurrent Neural Network for basic sequential patterns',
    icon: BarChart3,
    category: 'processing',
    color: '#fb923c',
    requiredInput: 'spreadsheetInput',
  },
  {
    type: 'tabularFFNN',
    label: 'FFNN',
    description: 'Feedforward Neural Network for standard tabular regression/classification',
    icon: BarChart3,
    category: 'processing',
    color: '#fb923c',
    requiredInput: 'spreadsheetInput',
  },
  {
    type: 'tabularDNN',
    label: 'Deep NN',
    description: 'Deep Neural Network with many layers for complex tabular patterns',
    icon: BarChart3,
    category: 'processing',
    color: '#fb923c',
    requiredInput: 'spreadsheetInput',
